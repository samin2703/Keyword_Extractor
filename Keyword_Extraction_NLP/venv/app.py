...
with open('D:/codespace/VScode/Keyword_Extraction_NLP/venv/count_vectorizer.pkl', 'rb') as f:
    cv = pickle.load(f)

with open('D:/codespace/VScode/Keyword_Extraction_NLP/venv/tfidf_transformer.pkl', 'rb') as f:
    tfidf_transformer = pickle.load(f)

with open('D:/codespace/VScode/Keyword_Extraction_NLP/venv/feature_names.pkl', 'rb') as f:
